/**
 * Login page — emerald/amber themed, animated, with form validation.
 */
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#050a08] flex items-center justify-center px-4 py-12 relative overflow-hidden">
      {/* Background effects */}
      <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] rounded-full bg-primary-600/8 blur-[120px]" />
      <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] rounded-full bg-accent-500/6 blur-[100px]" />
        ...
        >
            ...
            >
              <label className="flex items-center gap-2.5 cursor-pointer group">
                <div className="relative">
                  ...
                  />
                  <div className="w-4.5 h-4.5 rounded border border-white/20 bg-white/5 peer-checked:bg-primary-500 peer-checked:border-primary-500 transition-all duration-200 flex items-center justify-center">
                    {rememberMe && (
                      <motion.svg
                        initial={{ scale: 0 }}
                        animate={{ scale: 1 }}
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-3 bg-[#0a0f0d] text-surface-500">or continue with</span>
            </div>
          </div>

          {/* Social Login Buttons — OAuth not yet implemented */}
          {oauthMessage && (
            <motion.p
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
