...
const footerLinks = {
  Product: ['Features', 'Pricing', 'Changelog', 'Integrations', 'API Docs', 'Status'],
  Company: ['About', 'Blog', 'Careers', 'Press Kit', 'Contact'],
  Resources: ['Documentation', 'Tutorials', 'Community', 'Templates', 'Support Center'],
...
export default function Footer() {
  return (
    <footer className="relative border-t border-white/5 bg-[#050a08]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 mb-12">
          ...
          <div className="col-span-2">
            ...
            <p className="text-sm text-surface-500 leading-relaxed mb-6 max-w-xs">
              The AI-powered coding assistant that helps you write, debug, and ship code faster. Built for developers who demand the best.
            </p>
            <div className="flex gap-3">
              {socialLinks.map((social) => (
                <a
                  key={social.name}
                  href="#"
                  className="w-9 h-9 rounded-lg bg-white/5 hover:bg-white/10 flex items-center justify-center text-surface-500 hover:text-white transition-all duration-300"
              ...
              <ul className="space-y-2.5">
                {links.map((link) => (
                  <li key={link}>
                    <a
                      href="#"
                      className="text-sm text-surface-500 hover:text-white transition-colors duration-300"
                    >
                      {link}
                    </a>
                  </li>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            <a href="#" className="text-xs text-surface-600 hover:text-surface-400 transition-colors">
              Privacy
            </a>
            <a href="#" className="text-xs text-surface-600 hover:text-surface-400 transition-colors">
              Terms
